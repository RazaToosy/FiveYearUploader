...
using FiveYearUploader.Utilities.Commands;
using FiveYearUploader.Utilities.Data;
using FiveYearUploader.Utilities.IO;
using Microsoft.Win32;
using FiveYearUploader.Annotations;
using FiveYearUploader.Properties;
using FiveYearUploader.Utilities.Mapping;

namespace FiveYearUploader.UI.ViewModels
{
